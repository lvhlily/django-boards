...
class Board(models.Model):
    ...
    #Define __str__ method in Board model for a string representation of an object
    def __str__(self):
        return self.name
...
class Post(models.Model):
    ...
    created_by = models.ForeignKey(User, related_name='post', on_delete=models.DO_NOTHING)
